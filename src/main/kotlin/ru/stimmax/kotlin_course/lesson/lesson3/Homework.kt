...
private val contacts_contract:String "Здесь ссылка на контакты и контракты"
...
// 13. Количество команд(публичное будет инициализированно позже изменяемое)
lateinit var nmr_of_teams
