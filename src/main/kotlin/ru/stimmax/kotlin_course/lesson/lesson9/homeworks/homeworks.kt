...
// инициализируйте его несколькими значениями (например, "Kotlin", "Java", "Scala").

    val st3 = mutableSetOf("Kotlin", "Java", "Scala")
...
// Имея изменяемое множество целых чисел, удалите из него определенный элемент (например, 2).
    val st4 = mutableSetOf(1, 2, 3, 4, 5)
    st4.remove(2)
...
fun ex3(set: Set<String>, str: String): Boolean {
    for (el in set) {
        if (el == str) {
            return true
        }
...
// конвертируйте его в изменяемый список строк
// с использованием цикла.


fun ex5() {
    val st5 = setOf("1", "2", "3", "4", "5")
    val lt21 = mutableListOf<String>()
    for (el in st5) {
        lt21.add(el)
    }
}